        ...
        try {
            ...
            while (i < mAdapter.sale_return_list.size()) {
                if (Integer.parseInt(mAdapter.sale_return_list.get(i).getSelected_return_qty()) > 0) {
                    ...
                    obj.put("qtynumber", mAdapter.sale_return_list.get(i).getQuantity());
                    ...
                    obj.put("rateper", mAdapter.sale_return_list.get(i).getSingleTaxRatePer());
                    obj.put("single_discount_amt", Float.parseFloat(mAdapter.sale_return_list.get(i).getSingleDiscountAmt()));
                    obj.put("discount", mAdapter.sale_return_list.get(i).getSingleDiscountPer());
//                   float return_tax = Float.parseFloat(mAdapter.sale_return_list.get(i).getSingle_Tax_Amt()) * Integer.parseInt(mAdapter.sale_return_list.get(i).getSelected_return_qty());
                    ...
                    obj.put("returntaxamt", total_tax_amount);
                    obj.put("returncgst", (total_tax_amount / 2));
                    obj.put("returnsgst", (total_tax_amount / 2));
                    obj.put("returnbasicamt", total_basic);
                    obj.put("returnAmt", (total_taxable_amount + total_tax_amount));
                    obj.put("returnqty", mAdapter.sale_return_list.get(i).getSelected_return_qty());
                    obj.put("returndiscamt", discount_amount);
                    array.put(obj);
                }
                i++;
            }
