...
public class DemandListAdapter extends RecyclerView.Adapter<DemandListAdapter.DemandListViewHolder> {
    ...
    @NonNull
    @Override
    public DemandListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.demand_list_layout, parent, false);
        DemandListViewHolder evh = new DemandListViewHolder(v);
        return evh;
    }

    @Override
    public void onBindViewHolder(@NonNull final DemandListViewHolder holder, int i) {
